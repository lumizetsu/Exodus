...
class Exodus
{
  ...
  private:
    ...
    {
        auto app = reinterpret_cast<Exodus *>(glfwGetWindowUserPointer(window));
    ...
    void updateUniformBuffer(uint32_t currentImage)
    {
        ...
        ubo.proj = glm::perspective(glm::radians(20.0f + (90.0f - 20.0f) * 0.5f * (1.0f + std::sin(1.0f * time * glm::two_pi<float>()))), swapChainExtent.width / (float) swapChainExtent.height, 0.1f, 10.0f);
